...
seurat_object <- LoadH5Seurat(glue("/gpfs/gibbs/pi/girgenti/JZhang/CL/cellChat/PTSD_call/RNA_FINAL-{condition}.h5seurat"), meta.data = FALSE, misc = FALSE)
meta <- read.csv(file = glue('/gpfs/gibbs/pi/girgenti/JZhang/CL/cellChat/PTSD_call/RNA_FINAL-{condition}.csv'),sep = ',',row.names='barcodekey')
...
saveRDS(cellchat, 
        file = glue("/gpfs/gibbs/pi/girgenti/JZhang/CL/cellChat/PTSD_call/parameter_tuning/RNA_FINAL-{condition}-type_{type}-trim_{trim}_cellchat.rds"))
